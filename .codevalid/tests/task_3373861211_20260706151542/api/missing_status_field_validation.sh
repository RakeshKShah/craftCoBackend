...
CASE_SUFFIX="$(date +%s)-$$"
SELLER_USER_ID="user_missing_status_${CASE_SUFFIX}"
SELLER_ID="seller_missing_status_${CASE_SUFFIX}"
ADMIN_EMAIL="admin_missing_status_${CASE_SUFFIX}@example.com"
SELLER_EMAIL="seller_missing_status_${CASE_SUFFIX}@example.com"
...
VALUES ('${SELLER_ID}', '${SELLER_USER_ID}', 'Missing Status Shop ${CASE_SUFFIX}', 'Missing status bio ${CASE_SUFFIX}');
SQL
